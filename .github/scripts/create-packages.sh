...
rm -rf "$target_folder/solution/.tours"
...
rm -rf "$target_folder/solution/.github/workflows/docs.yaml"
rm -rf "$target_folder/solution/.github/workflows/packages.yaml"
rm -rf "$target_folder/solution/.github/workflows/stale-bot.yaml"
rm -rf "$target_folder/solution/.github/workflows/slides.yaml"
rm -rf "$target_folder/solution/.github/workflows/build-test.yaml"
rm -rf "$target_folder/solution/.github/workflows/validate-infra.yaml"
rm -rf "$target_folder/solution/TODO*"
rm -rf "$target_folder/solution/packages/agent-cli"
rm -rf "$target_folder/solution/packages/beer-mcp"
...
cp .github/workflows/deploy.yaml "$target_folder/ci-cd/.github/workflows/deploy.yaml"
